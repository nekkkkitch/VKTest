...
func (c *pubSubClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (PubSub_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &PubSub_ServiceDesc.Streams[0], "/subpubservice.PubSub/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pubSubClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/subpubservice.PubSub/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PubSub_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/subpubservice.PubSub/Publish",
	}
...
var PubSub_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "subpubservice.PubSub",
